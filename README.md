...
| `cpt-exporter-button.php` | Sur la liste d'un type coché dans les réglages, ajoute un menu déroulant **Export** (CSV, XLS) dans la barre d'outils, pour les utilisateurs ayant la capacité `export`. Les options ne déclenchent encore rien. |
